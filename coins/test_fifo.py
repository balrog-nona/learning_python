...
# TEST CASE 1
transaction1 = {'type': 'buy', 'date': '1.1.2021', 'currency': 'ETH', 'quantity': 0.8,
                'price': 1000.0, 'value': None}
transaction1['value'] = transaction1['price'] * transaction1['quantity']

transaction2 = {'type': 'buy', 'date': '1.2.2021', 'currency': 'ETH', 'quantity': 0.5,
                'price': 2000.0, 'value': None}
transaction2['value'] = transaction2['price'] * transaction2['quantity']

transaction3 = {'type': 'sale', 'date': '1.3.2021', 'currency': 'ETH', 'quantity': 0.3,
                'price': 3000.0, 'value': None}
transaction3['value'] = transaction3['price'] * transaction3['quantity']

transaction4 = {'type': 'sale', 'date': '1.4.2021', 'currency': 'ETH', 'quantity': 0.9,
