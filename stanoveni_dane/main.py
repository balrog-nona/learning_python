#!/usr/bin/env python3
"""
Funkce na kompletni vypocet lhuty pro stanoveni dane. Jednotlive ukonu
jsou objety sve tridy a jsou do fce srovnane podle atributu ukon.

Upraveny pripady soubehu odstavce 2, 3 a 4 ve staveni.
Nakonec se na kazdem ukonu zavola metoda konec_lhuty.
Vysledek z posledniho ukonu je konec lhuty pro stanoveni dane.
"""


from lhuta_komplet import Odst1
