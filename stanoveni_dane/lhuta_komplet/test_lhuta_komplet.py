...
def test_odst2():
    ...
    odst2.konec_lhuty(datum_zacatku=odst1._ukon, datum_konce=odst1._konec, maximalni_delka=odst1._maximalni)
...
def test_odst3():
    ...
    odst3.konec_lhuty(datum_zacatku=odst1._ukon, datum_konce=odst1._konec, maximalni_delka=odst1._maximalni)
    assert odst3._vrat_konec(datum=odst3._konec) == '22.09.2025'

    extension = Odst3(datum='11.3.2025')
    extension.konec_lhuty(datum_zacatku=odst1._ukon, datum_konce=odst3._konec, maximalni_delka=odst1._maximalni)
    assert extension._vrat_konec(datum=extension._konec) == '13.03.2028'

    extension2 = Odst3(datum='13.03.2028')
    extension2.konec_lhuty(datum_zacatku=odst1._ukon, datum_konce=extension._konec, maximalni_delka=odst1._maximalni)
...
def test_odst4():
    ...
    odst4.konec_lhuty(datum_zacatku=odst1._ukon, datum_konce=odst1._konec, maximalni_delka=odst1._maximalni)
    ...
    extension.konec_lhuty(datum_zacatku=odst1._ukon, datum_konce=odst4._konec, maximalni_delka=odst1._maximalni)
...
def test_kompletni1():
    ...
    odst2.konec_lhuty(datum_zacatku=odst1._ukon, datum_konce=odst3._konec, maximalni_delka=odst1._maximalni)
    ...
    odst4.konec_lhuty(datum_zacatku=odst1._ukon, datum_konce=odst2._konec, maximalni_delka=odst1._maximalni)
...
def test_kompetni2():
    ...
    odst2.konec_lhuty(datum_zacatku=odst1._ukon, datum_konce=konec, maximalni_delka=odst1._maximalni)
    assert odst2._konec == datetime.date(2025, 10, 9)
    assert odst2._konec == konec

    odst4 = Odst4(datum='1.4.2024')  # soud
    odst4.zadej_konec_staveni(konec_staveni='19.1.2025')
    odst4.konec_lhuty(datum_zacatku=odst1._ukon, datum_konce=konec, maximalni_delka=odst1._maximalni)
    assert odst4._konec == datetime.date(2026, 7, 30)

    odst2 = Odst2(datum='22.5.2025')  # R o odvolani
    odst2.konec_lhuty(datum_zacatku=odst1._ukon, datum_konce=odst4._konec, maximalni_delka=odst1._maximalni)
